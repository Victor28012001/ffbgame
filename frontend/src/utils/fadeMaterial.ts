...
export const fadeOnBeforeCompile = (shader: { fragmentShader: string }): void => {
  shader.fragmentShader = replaceFragmentShader(shader.fragmentShader);
};

export const fadeOnBeforeCompileFlat = (shader: { fragmentShader: string }): void => {
