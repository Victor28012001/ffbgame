...
const YourCharacters = () => {
    ...
    const [creatorCharacterDetails] = useState<CharacterDetails[]>([]);
        ...
        <section className="w-full h-auto bg-bodyBg">
            <main className="w-full lg:py-24 md:py-24 py-20 md:px-6 px-3 flex flex-col items-center gap-4">
                ...
                <section className="w-full mt-7 px-3 md:px-0">
                    {creatorCharacterDetails.length > 0 ? 
                    ...
                    </Carousel>) : (<Text as="h5" className="mt-5 font-belanosima text-center text-2xl">No player Available</Text>) }
                </section>
            </main>
        </section>
    )
