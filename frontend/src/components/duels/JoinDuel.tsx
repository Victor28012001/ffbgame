...
const JoinDuelComp = () => {
  ...
  const submitTx = async () => {
    ...
    interface MessageData {
      ...
      data: {       // Object that contains relevant duel information
          char_id1: number;
          char_id2: number;
          char_id3: number;
          duel_id: number; // Assuming duel_id is required
      };
  }
  
  // Creating the dataObject with required structure
  const dataObject: MessageData = {
      ...
      data: {
          ...
          duel_id: Number(+(duelId as string)), // Convert duelId to number
      },
  };
