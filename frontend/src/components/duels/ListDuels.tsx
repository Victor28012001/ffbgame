...
const ListDuels = () => {
  ...
  return (
    <div className="main--area overflow-x-hidden w-full flex flex-col items-center">
      {/* Breadcrumb Area */}
      <section className="breadcrumb-area relative bg-center bg-cover min-h-[561px] flex items-center pt-[110px] pb-[75px] px-0 before:content-[''] before:absolute before:w-6/12 before:bg-[#58105a] before:h-[50px] before:left-0 before:bottom-0 after:content-[''] after:absolute after:w-6/12 after:bg-[#58105a] after:h-[50px] after:left-auto after:right-0 after:bottom-0 before:clip-path-polygon-[0_0,0_100%,100%_100%] after:clip-path-polygon-[100%_0,0_100%,100%_100%]">
                ...
                <div className="breadcrumb__content text-left md:text-center sm:text-center xsm:text-center">
                  ...
                  <nav>
                    <ol className=" justify-start sm:justify-center xsm:justify-center mt-3 mb-0 mx-0 flex flex-wrap list-none md:justify-center sm:text-center xsm:text-center">
                      <li className=" uppercase font-bold text-[14px] tracking-[2px] flex items-center after:content-[''] after:block after:w-2 after:h-2 after:transition-all after:duration-[0.3s] after:ease-[ease-out] after:mx-2.5 after:rounded-full after:bg-[#58105a] hover:after:bg-[#ffbe18]">
                        <Link
                          to={`/Home`}
                          className="hover:text-[#ffbe18] text-[#58105a]"
                        >
                          Home
                        </Link>
                      </li>
                      <li
                        className="uppercase font-bold text-[14px] tracking-[2px] flex items-center after:content-[''] after:block after:w-2 after:h-2 after:transition-all after:duration-[0.3s] after:ease-[ease-out] after:mx-2.5 after:rounded-full after:bg-[#58105a] hover:after:bg-[#ffbe18] active text-[#fff]"
                        aria-current="page"
                      >
                        Tournament
                      </li>
      ...
      {/* See Duel List */}
      <div className=" float-right border md:mr-20 mt-10 md:mb-20 py-2 md:py-3 px-6 md:px-10 rounded-md border-[#58105a] text-sm md:text-lg shadow-md shadow-purple-300 hover:bg-[#58105a] hover:text-black hover:cursor-pointer" onClick={routeToCreateDuel}>
            <p className=" font-belanosima"> + Create Match</p>
      </div>

      <section className="breadcrumb-area-02 w-[100%] pb-[120px] pt-10 bg-center bg-cover mt-10">
        <div className=" p-10">
          <div className="flex justify-center mb-4">
          <button
              onClick={() => setActiveTab("open")}
              className={`md:px-8 px-3 py-2 mx-2 rounded-xl transition duration-500 ease-in-out transform hover:-translate-y-1 text-xs md:text-xl font-belanosima hover:scale-110 ${
                activeTab === "open" ? "bg-[#58105a] text-black" : "bg-gray-700"
              }`}
            >
              Available Matches
            </button>
            <button
              ...
              className={`md:px-8 px-3 py-2 mx-2 rounded-xl transition duration-500 ease-in-out transform hover:-translate-y-1 text-xs md:text-xl font-belanosima hover:scale-110 ${
                activeTab === "all" ? "bg-[#58105a] text-black" : "bg-gray-700"
              }`}
            >
              P2P Matches
            </button>
            <button
              ...
              className={`md:px-8 px-3 mx-2 rounded-xl transition duration-500 ease-in-out transform hover:-translate-y-1 text-xs md:text-xl font-belanosima hover:scale-110 ${
                activeTab === "ai" ? "bg-[#58105a] text-black" : "bg-gray-700"
              }`}
            >
              Tournament
            </button>
          ...
          <div className=" p-6">
            ...
            ) : <div className=" mt-14 text-center text-white font-belanosima text-xl h-60 py-28"> Awaiting Matches Data...... </div>}
          </div>
        </div>
      </section>
      {/* <DuelComponent /> */}
