            ...
            <div className="w-full flex flex-col gap-4">
              ...
              <div className="w-full flex flex-col gap-1.5">
                <div className="w-full flex justify-between items-center">
                  <Text
                    as="h4"
                    className="text-gray-100 font-bold font-poppins"
                  >
                    {item.name}
                  </Text>
                  <Text
      ...
      <section className="w-full flex justify-center gap-3 items-center mt-8">
        {[...Array(3)].map((_, index) => (
          <Button
            type="button"
            key={index}
            className="h-14 w-14 bg-navBg text-gray-300 flex justify-center first:bg-myGreen first:text-navBg items-center text-sm font-bold rounded-md border border-gray-800"
          >{`0${index + 1}`}</Button>
        ))}
        <Button
          type="button"
          className="h-14 w-14 bg-navBg text-gray-300 flex justify-center items-center text-sm font-bold rounded-md border border-gray-800"
        >
          ...
        </Button>
        <Button
