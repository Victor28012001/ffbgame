...
// import { ERC20Portal, DAPP, CTSI, ADDRESS_RELAYER } from '../../utils/tokenPortal'
...
//       data: {
//         // Object that contains relevant transfer information
//         trf_amount: number
//         receiver_add: string
...
//     // Creating the payload with the required structure
//     const payload: MessageData = {
//       func: 'transfer_funds', // Replace with your actual function name
//       data: {
//         trf_amount: 100, // Replace with the actual transfer amount
//         receiver_add: 'receiver_address_here', // Replace with the actual receiver address
//       },
//     }
...
//       func: string // Function name
//       data: {
//         // Object that contains relevant withdrawal information
//         amount: number // Amount to withdraw
//         // Include any other necessary properties
//       }
//     }

//     // Main logic to check the game state and create the payload
//     const { Status, request_payload } = await readGameState(`check_relayed_dapp_address`)
//     const payload: MessageData = {
//       func: 'withdraw',
//       data: {
//         // Wrapping the existing properties in a 'data' object
...
//         toast.info('Sending Tx to relayer, please wait...')
//         await signMessages(payload) // Now payload is correctly structured
//         toast.success('Withdrawal submitted, please refresh page')
...
//             >
//               {formatAddress(
//                 userAddress ? userAddress : '0x00000000000000000000000000000000000'
//               )}
//             </Text>
...
//           <Text as='h4' className='text-gray-100 text-base md:text-lg font-poppins'>
...
//   if (!address) {
//     return (
//       <div className='text-2xl relative w-full h-screen'>
//         <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-red-500 text-center'>Error loading account</div>
//       </div>
//     )
//   }
