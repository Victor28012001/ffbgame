        ...
        <section className="w-full h-auto">
            <main className="w-full lg:py-44 md:py-32 py-24 px-6 grid md:grid-cols-2 lg:gap-4 md:gap-8 gap-12">
                <div className="flex flex-col relative">
                    ...
                    <a href="tel:+234 806 8977" className="block hover:text-myGreen">+234 8137 1390 81</a>
                    <a href="mailto:hello@nebula.io" className="block hover:text-myGreen">TheOzone@gmail.com</a>
                    <Text as={`p`} className="text-lg">Unizik, ifite-Awka, Awka, Anambra</Text>
                </div>
                ...
                <div className="w-full">
                    <form className="w-full ">
                        ...
                        <Button type="button" className=" text-[#0f161b] uppercase font-bold tracking-[1px] px-[30px] py-3.5 border-[none] bg-[#58105a]  font-Barlow hover:bg-[#ffbe18] clip-path-polygon-[100%_0,100%_65%,89%_100%,0_100%,0_0]">Submit Now</Button>
                    </form>
                </div>
            </main>
        </section>
