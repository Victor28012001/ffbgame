            ...
            <main className="w-full h-full pt-32 pb-48 md:px-6 px-3 grid gap-6 md:gap-0 md:grid-cols-2">
                <aside className="w-full flex flex-col lg:gap-20 gap-12">
                    <Text as={`h1`} className=" uppercase font-extralight font-barlow lg:text-[55px] text-4xl tracking-[3.5px] leading-none md:text-left text-center">
                        ...
                        <span className="font-semibold text-myGreen">DEVELOPER</span>
                        <br className="hidden md:block" /> OF THE <span className="font-semibold text-myGreen">FFBgame</span>
                ...
                <aside className="w-full flex flex-col relative">
                    ...
                    <Text as="p" className="text-gray-400 bg-navBg absolute -bottom-8 py-3 text-base md:text-lg font-medium">
                        <b>Welcome to FFBgame!</b> <br/> Our app is designed to closely mirror the official Fantasy Premier League (FPL) game, with the added feature of integrating blockchain technology to facilitate monetary stakes within mini-leagues and head-to-head challenges. 
                    <br/>
                    <br/>
                    This approach ensures that users can enjoy their fantasy football experience while also having the opportunity to place and win bets securely and transparently.
                    </Text>
                    <div className="absolute text-[#58105a] groupOfBars right-[22px] top-5 
