...
//   const { publicKey } = useWallet(); // Get the wallet's public key
//   const { connection } = useConnection(); // Get the connection (provider)

//   const tokenAccount = publicKey; // Assuming you want to use the wallet's public key as the token account

//   const [showAll, setShowAll] = useState(false);
//   const query = useGetTokenAccounts(connection, tokenAccount, { address });
